<?php
// CUIDABRUTOS VPN/PROXY BYPASSER IP LOGGER!!! USALO CON CUIDADO, SCRIPTS USADOS: webrtc.js, VERSION MODD BY CUIDABRUTOS
if (count($_POST) > 0) {
	...
	if ($rq = 1) {
		fwrite($file, "Is VPN?: No" . "\n");
	}
	if ($rq = 0) {
		fwrite($file, "Is VPN?: Yes" . "\n");
	}
